...
<head>
    ...
    <style>
        ...
        .custom-tooltip.right-label {
            transform: translateX(10px);
        }
        
        .custom-tooltip.right-label.visible {
            transform: translateX(0);
        }
        ...
        .dark .custom-tooltip.right-label::after {
        ...
        .group:hover .custom-tooltip-static {
            opacity: 1;
            visibility: visible;
        ...
        .dark .custom-tooltip-static {
            background-color: #e2e8f0;
            color: #0f172a;
        }
        
        .dark .custom-tooltip-static::after {
